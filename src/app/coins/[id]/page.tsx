  ...
  return (
    <main className="main-container">
      <div id="coin-details-page" className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 items-start gap-6">
        ...
        <div className="secondary">
          <div id="converter" className="w-full space-y-5 bg-white p-5 rounded-xl border border-gray-200">
            ...
            <div className="panel space-y-2 bg-gray-50 px-5 py-7 rounded-lg">
              <input 
                type="number" 
                placeholder="Amount" 
            ...
            <div className="divider relative flex justify-center items-center my-4">
              ...
              <div className="size-8 z-20 bg-white rounded-full p-2 text-green-500 flex items-center justify-center border border-gray-200">↓</div>
            </div>
            ...
            <div className="output-wrapper bg-gray-100 h-12 w-full rounded-md flex items-center justify-between py-4 pl-4">
              ...
              <select className="w-fit border-none cursor-pointer h-12 bg-gray-100 text-purple-600 text-xs font-semibold px-3 rounded-md">
                <option>USD</option>
                <option>EUR</option>
                <option>GBP</option>
              </select>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-6">
        ...
        <div className="bg-white p-4 rounded-lg border border-gray-200">
          <p className="text-purple-100 text-sm">Volume (24h)</p>
        ...
        <div className="bg-white p-4 rounded-lg border border-gray-200">
          <p className="text-purple-100 text-sm">24h Change</p>
